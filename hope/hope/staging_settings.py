...
# we use development to get the unpacked js/css
INESC_ENV = 'DEVELOPMENT'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hope_staging',                         # Or path to database file if using sqlite3.
...
MONGO_DATABASE = 'hope_staging'
DB_URL = 'bdmoth.dec.uc.pt'
CDN_URL = 'http://webmoth.dec.uc.pt/staging'

# FACEBOOK INTEGRATION
FACEBOOK_APP_ID = "263709073753910"
FACEBOOK_APP_SECRET = "b28f6a727468146b76cddade4ffecc78"
...
#MONGO DB
MONGODB_HOPE = "hope_staging"

if 'test' in sys.argv:
    MONGODB_HOPE = "test_hope"
...
STATIC_URL = 'http://webmoth.dec.uc.pt/staging/'
#STATIC_URL = 'http://webmoth.dec.uc.pt/'
