	...
	/* Retrieve or reconfigure the settings for a control.
	   ...
	   @return  (any) if retrieving a value */
		_optionPlugin: function(target, options, value) {
			...
			bind('slide.' + this.propertyName + ',slide.' + this.propertyName, function(event, ui) {
				if (!plugin._linking) {
			...
			target.bind('slidechange.' + this.propertyName + ',slide.' + this.propertyName, function(event, ui) {
			...
			plugin._linkSliders(target, null, {
				handle: target
			}); // Initial synch
		},
