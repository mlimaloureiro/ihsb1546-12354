...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Videos'
        db.create_table('hopeapp_videos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('occurrence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hopeapp.Occurrences'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('hopeapp', ['Videos'])


    def backwards(self, orm):
        # Deleting model 'Videos'
        db.delete_table('hopeapp_videos')
